...
export const INITIAL_EVENTS: AssociationEvent[] = [
  {
    ...
    title: {
      ...
      de: 'Schulung "Grundlagen der Betriebssicherheit"',
      es: 'Formación "Fundamentos de la seguridad industrial"',
      kk: 'Тренинг "Өндірістік қауіпсіздік негіздері"',
      fr: 'Formation "Fondamentaux de la sécurité industrielle"',
    },
    shortDescription: {
      uk: 'Базовий тренінг для нових спеціалістів з охорони праці.',
      en: 'Basic training for new occupational safety specialists.',
      de: 'Grundlagenschulung für neue Fachkräfte für Arbeitssicherheit.',
      es: 'Formación básica para nuevos especialistas en seguridad laboral.',
      kk: 'Еңбек қауіпсіздігі бойынша жаңа мамандарға арналған базалық тренинг.',
      fr: 'Formation de base pour les nouveaux spécialistes de la sécurité au travail.',
    },
    fullDescription: {
      uk: 'Детальний опис тренінгу...',
      en: 'Detailed description of the training...',
      de: 'Detaillierte Beschreibung der Schulung...',
      es: 'Descripción detallada de la formación...',
      kk: 'Тренингтің толық сипаттамасы...',
      fr: 'Description détaillée de la formation...',
    },
    type: 'training',
    format: 'online',
  ...
  },
  {
    ...
    title: {
      ...
      de: 'Konferenz "Die Zukunft der Arbeitssicherheit"',
      es: 'Conferencia "El futuro de la seguridad laboral"',
      kk: 'Конференция "Еңбек қауіпсіздігінің болашағы"',
      fr: 'Conférence "L’avenir de la sécurité au travail"',
    },
    shortDescription: {
      uk: 'Щорічна конференція членів асоціації.',
      en: 'Annual conference of association members.',
      de: 'Jährliche Konferenz der Verbandsmitglieder.',
      es: 'Conferencia anual de los miembros de la asociación.',
      kk: 'Қауымдастық мүшелерінің жылдық конференциясы.',
      fr: 'Conférence annuelle des membres de l’association.',
    },
    fullDescription: {
      uk: 'Детальний опис конференції...',
      en: 'Detailed description of the conference...',
      de: 'Detaillierte Beschreibung der Konferenz...',
      es: 'Descripción detallada de la conferencia...',
      kk: 'Конференцияның толық сипаттамасы...',
      fr: 'Description détaillée de la conférence...',
    },
    type: 'conference',
    format: 'hybrid',
    ...
    location: {
      ...
      de: 'Kiew, Chreschtschatyk-Str. 1',
      es: 'Kyiv, calle Khreshchatyk, 1',
      kk: 'Киев қ., Хрещатик к-сі, 1',
      fr: 'Kyiv, rue Khrechtchatyk, 1',
    },
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },

...
export const industrialTranslations: Record<Locale, IndustrialDictionary> = {
  uk: {
    ...
    hero_title: 'Обʼєднуємо провідні компанії засобів захисту в Україні',
    hero_lead:
      'Виробники, постачальники та експертні організації у сфері засобів захисту на роботі - разом розвиваємо професійні стандарти та відповідальний ринок в Україні. Долучайтеся!',

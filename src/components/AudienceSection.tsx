...
export default function AudienceSection({currentLang, onCtaClick}: AudienceSectionProps) {
  ...
  const cards = [
    {title: t.audience_producer_title, desc: t.audience_producer_desc},
    {title: t.audience_consumer_title, desc: t.audience_consumer_desc},
    {title: t.audience_expert_title, desc: t.audience_expert_desc},
  ]
